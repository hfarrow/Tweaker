...
namespace Ghostbit.Tweaker.Core
{
        ...
        ITweakableManager
    {
        ...
        public ITweakable RegisterTweakable<T>(TweakableInfo<T> info, PropertyInfo tweakable, object instance)
        {
            return TweakableFactory.MakeTweakableFromInfo(info, tweakable, instance);
        }

        public ITweakable RegisterTweakable<T>(TweakableInfo<T> info, FieldInfo tweakable, object instance)
        {
            return TweakableFactory.MakeTweakableFromInfo(info, tweakable, instance);
        }
